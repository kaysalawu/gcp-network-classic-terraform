...
locals {
  ...
  hub_eu_run_flasky_repo_create = templatefile("../../init/run/flasky/create.sh", local.hub_eu_run_flasky_repo_vars)
  hub_eu_run_flasky_repo_delete = templatefile("../../init/run/flasky/delete.sh", local.hub_eu_run_flasky_repo_vars)
  hub_eu_run_flasky_repo_vars = {
    ...
    DOCKERFILE_DIR = "../../init/run/flasky"
  }
}
...
locals {
  ...
  spoke1_eu_run_flasky_repo_create = templatefile("../../init/run/flasky/create.sh", local.spoke1_eu_run_flasky_repo_vars)
  spoke1_eu_run_flasky_repo_delete = templatefile("../../init/run/flasky/delete.sh", local.spoke1_eu_run_flasky_repo_vars)
...
locals {
  ...
  spoke2_us_run_flasky_repo_create = templatefile("../../init/run/flasky/create.sh", local.spoke2_us_run_flasky_repo_vars)
  spoke2_us_run_flasky_repo_delete = templatefile("../../init/run/flasky/delete.sh", local.spoke2_us_run_flasky_repo_vars)
