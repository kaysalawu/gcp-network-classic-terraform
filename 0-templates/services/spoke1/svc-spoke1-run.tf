...
locals {
  ...
  spoke1_run_flasky_repo_create = templatefile("../../init/run/flasky/create.sh", local.spoke1_run_flasky_repo_vars)
  spoke1_run_flasky_repo_delete = templatefile("../../init/run/flasky/delete.sh", local.spoke1_run_flasky_repo_vars)
