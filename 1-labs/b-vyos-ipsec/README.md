# LAB B: Hub and Spoke with Appliance IPsec Tunnel to On-premises <!-- omit from toc -->
...
```sh
admin_cloudtuple_com@b-site1-vm:~$ playz

 apps ...

200 (0.012026s) - 10.10.1.9 - app1.site1.onprem:8080/
200 (0.301502s) - 10.20.1.9 - app1.site2.onprem:8080/
200 (0.016228s) - 10.1.11.70 - ilb4.eu.hub.gcp:8080/
200 (0.298397s) - 10.1.21.70 - ilb4.us.hub.gcp:8080/
200 (0.038595s) - 10.1.11.80 - ilb7.eu.hub.gcp/
000 (2.002227s) -  - ilb7.us.hub.gcp/
200 (0.010954s) - 10.11.11.30 - ilb4.eu.spoke1.gcp:8080/
200 (0.293315s) - 10.22.21.30 - ilb4.us.spoke2.gcp:8080/
200 (0.036353s) - 10.11.11.40 - ilb7.eu.spoke1.gcp/
200 (0.718120s) - 10.22.21.40 - ilb7.us.spoke2.gcp/

 psc4 ...

000 (0.128477s) -  - psc4.consumer.spoke2-us-svc.psc.hub.gcp:8080
000 (0.128515s) -  - psc4.consumer.spoke2-us-svc.psc.spoke1.gcp:8080

 apis ...

204 (0.003714s) - 142.250.187.202 - www.googleapis.com/generate_204
204 (0.007850s) - 10.1.0.1 - storage.googleapis.com/generate_204
204 (0.039618s) - 10.1.11.80 - europe-west2-run.googleapis.com/generate_204
204 (1.577937s) - 10.22.21.40 - us-west2-run.googleapis.com/generate_204
204 (0.023847s) - 10.1.11.80 - europe-west2-run.googleapis.com/generate_204
204 (1.717843s) - 10.22.21.40 - us-west2-run.googleapis.com/generate_204
200 (0.044146s) - 10.1.0.1 - https://b-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app/
200 (0.041178s) - 10.1.0.1 - https://b-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app/
200 (0.195350s) - 10.1.0.1 - https://b-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app/
204 (0.008053s) - 10.1.0.1 - bhuball.p.googleapis.com/generate_204
204 (0.003183s) - 216.58.201.106 - bspoke1sec.p.googleapis.com/generate_204
204 (0.003395s) - 142.250.179.234 - bspoke2sec.p.googleapis.com/generate_204
```
...
```sh
admin_cloudtuple_com@b-site1-vm:~$ pingz

 ping ...

app1.site1.onprem - OK 0.018 ms
app1.site2.onprem - OK 141.996 ms
ilb4.eu.hub.gcp - NA
ilb4.us.hub.gcp - NA
ilb7.eu.hub.gcp - NA
ilb7.us.hub.gcp - NA
...
```sh
admin_cloudtuple_com@b-site1-vm:~$ bucketz
...
```sh
admin_cloudtuple_com@b-spoke1-eu-ilb4-vm:~$ playz

 apps ...

200 (0.152252s) - 10.10.1.9 - app1.site1.onprem:8080/
200 (0.430798s) - 10.20.1.9 - app1.site2.onprem:8080/
200 (0.007691s) - 10.1.11.70 - ilb4.eu.hub.gcp:8080/
200 (0.286741s) - 10.1.21.70 - ilb4.us.hub.gcp:8080/
200 (0.032309s) - 10.1.11.80 - ilb7.eu.hub.gcp/
000 (2.002828s) -  - ilb7.us.hub.gcp/
200 (0.005846s) - 10.11.11.30 - ilb4.eu.spoke1.gcp:8080/
200 (0.288405s) - 10.22.21.30 - ilb4.us.spoke2.gcp:8080/
200 (0.030421s) - 10.11.11.40 - ilb7.eu.spoke1.gcp/
200 (0.712276s) - 10.22.21.40 - ilb7.us.spoke2.gcp/

 psc4 ...

000 (0.015704s) -  - psc4.consumer.spoke2-us-svc.psc.hub.gcp:8080
000 (0.007529s) -  - psc4.consumer.spoke2-us-svc.psc.spoke1.gcp:8080

 apis ...

204 (0.003128s) - 142.250.200.42 - www.googleapis.com/generate_204
204 (0.002663s) - 10.11.0.2 - storage.googleapis.com/generate_204
204 (0.028418s) - 10.11.11.40 - europe-west2-run.googleapis.com/generate_204
000 (2.001868s) -  - us-west2-run.googleapis.com/generate_204
204 (0.013379s) - 10.11.11.40 - europe-west2-run.googleapis.com/generate_204
000 (2.002596s) -  - us-west2-run.googleapis.com/generate_204
200 (0.030869s) - 10.11.0.2 - https://b-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app/
200 (0.035081s) - 10.11.0.2 - https://b-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app/
200 (0.855370s) - 10.11.0.2 - https://b-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app/
000 (0.007510s) -  - bhuball.p.googleapis.com/generate_204
204 (0.004832s) - 10.11.0.2 - bspoke1sec.p.googleapis.com/generate_204
204 (0.277168s) - 10.22.0.2 - bspoke2sec.p.googleapis.com/generate_204
```
...
```sh
admin_cloudtuple_com@b-spoke1-eu-ilb4-vm:~$ pingz

 ping ...

app1.site1.onprem - OK 1.786 ms
app1.site2.onprem - OK 138.424 ms
ilb4.eu.hub.gcp - NA
ilb4.us.hub.gcp - NA
ilb7.eu.hub.gcp - NA
ilb7.us.hub.gcp - NA
...
```sh
admin_cloudtuple_com@b-spoke1-eu-ilb4-vm:~$ bucketz
