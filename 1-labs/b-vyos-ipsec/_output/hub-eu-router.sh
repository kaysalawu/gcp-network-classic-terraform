...
write_files:
  - path: /opt/vyatta/etc/config/scripts/vyos-postconfig-bootup.script
    ...
    content: |
      ...
      set vpn ipsec site-to-site peer 34.105.178.10 authentication id '10.1.11.10'
      set vpn ipsec site-to-site peer 34.105.178.10 authentication remote-id '10.10.1.2'
      set vpn ipsec site-to-site peer 34.105.178.10 authentication mode 'pre-shared-secret'
      set vpn ipsec site-to-site peer 34.105.178.10 authentication pre-shared-secret 'Password123'
      set vpn ipsec site-to-site peer 34.105.178.10 connection-type 'respond'
      set vpn ipsec site-to-site peer 34.105.178.10 ike-group 'IKEv2-GROUP'
      set vpn ipsec site-to-site peer 34.105.178.10 ikev2-reauth 'inherit'
      set vpn ipsec site-to-site peer 34.105.178.10 local-address '10.1.11.10'
      set vpn ipsec site-to-site peer 34.105.178.10 vti bind 'vti0'
      set vpn ipsec site-to-site peer 34.105.178.10 vti esp-group 'ESP-GROUP'
      set vpn ipsec site-to-site peer 34.105.178.10 description 'SITE-TUN0'
