...
write_files:
  - path: /opt/vyatta/etc/config/scripts/vyos-postconfig-bootup.script
    ...
    content: |
      ...
      set vpn ipsec site-to-site peer 34.147.174.167 authentication id '10.10.1.2'
      set vpn ipsec site-to-site peer 34.147.174.167 authentication remote-id '10.1.11.10'
      set vpn ipsec site-to-site peer 34.147.174.167 authentication mode 'pre-shared-secret'
      set vpn ipsec site-to-site peer 34.147.174.167 authentication pre-shared-secret 'Password123'
      set vpn ipsec site-to-site peer 34.147.174.167 connection-type 'initiate'
      set vpn ipsec site-to-site peer 34.147.174.167 ike-group 'IKEv2-GROUP'
      set vpn ipsec site-to-site peer 34.147.174.167 ikev2-reauth 'inherit'
      set vpn ipsec site-to-site peer 34.147.174.167 local-address '10.10.1.2'
      set vpn ipsec site-to-site peer 34.147.174.167 vti bind 'vti0'
      set vpn ipsec site-to-site peer 34.147.174.167 vti esp-group 'ESP-GROUP'
      set vpn ipsec site-to-site peer 34.147.174.167 description 'HUB-TUN0'
