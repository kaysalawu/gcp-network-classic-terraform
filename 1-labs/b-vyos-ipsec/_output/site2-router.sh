...
write_files:
  - path: /opt/vyatta/etc/config/scripts/vyos-postconfig-bootup.script
    ...
    content: |
      ...
      set vpn ipsec site-to-site peer 35.235.65.236 authentication id '10.20.1.2'
      set vpn ipsec site-to-site peer 35.235.65.236 authentication remote-id '10.1.21.10'
      set vpn ipsec site-to-site peer 35.235.65.236 authentication mode 'pre-shared-secret'
      set vpn ipsec site-to-site peer 35.235.65.236 authentication pre-shared-secret 'Password123'
      set vpn ipsec site-to-site peer 35.235.65.236 connection-type 'initiate'
      set vpn ipsec site-to-site peer 35.235.65.236 ike-group 'IKEv2-GROUP'
      set vpn ipsec site-to-site peer 35.235.65.236 ikev2-reauth 'inherit'
      set vpn ipsec site-to-site peer 35.235.65.236 local-address '10.20.1.2'
      set vpn ipsec site-to-site peer 35.235.65.236 vti bind 'vti0'
      set vpn ipsec site-to-site peer 35.235.65.236 vti esp-group 'ESP-GROUP'
      set vpn ipsec site-to-site peer 35.235.65.236 description 'HUB-TUN0'
