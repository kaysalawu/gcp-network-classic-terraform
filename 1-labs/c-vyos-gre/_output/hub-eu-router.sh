...
write_files:
  - path: /opt/vyatta/etc/config/scripts/vyos-postconfig-bootup.script
    ...
    content: |
      ...
      set protocols static route 10.10.1.2/32 next-hop 10.1.11.1
      ...
      set interfaces tunnel tun0 source-address 10.1.11.10
      set interfaces tunnel tun0 remote 10.10.1.2
      ...
      set protocols bgp 65001 neighbor 172.16.1.1 remote-as '65010'
      set protocols bgp 65001 neighbor 172.16.1.1 address-family ipv4-unicast soft-reconfiguration inbound
      set protocols bgp 65001 neighbor 172.16.1.1 timers holdtime '60'
      set protocols bgp 65001 neighbor 172.16.1.1 timers keepalive '20'

      set protocols bgp 65001 neighbor 172.16.1.1 address-family ipv4-unicast route-map export 'MAP-OUT-SITE'


      set protocols bgp 65001 neighbor 172.16.1.1 address-family ipv4-unicast route-map import 'MAP-IN-SITE'


      set protocols bgp 65001 neighbor 172.16.1.1 ebgp-multihop 4
