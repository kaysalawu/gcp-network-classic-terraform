...
write_files:
  - path: /opt/vyatta/etc/config/scripts/vyos-postconfig-bootup.script
    ...
    content: |
      ...
      set protocols static route 10.1.21.10/32 next-hop 10.20.1.1
      ...
      set interfaces tunnel tun0 source-address 10.20.1.2
      set interfaces tunnel tun0 remote 10.1.21.10
      ...
      set protocols bgp 65020 neighbor 172.16.2.2 remote-as '65002'
      set protocols bgp 65020 neighbor 172.16.2.2 address-family ipv4-unicast soft-reconfiguration inbound
      set protocols bgp 65020 neighbor 172.16.2.2 timers holdtime '60'
      set protocols bgp 65020 neighbor 172.16.2.2 timers keepalive '20'

      set protocols bgp 65020 neighbor 172.16.2.2 address-family ipv4-unicast route-map export 'MAP-OUT-HUB'


      set protocols bgp 65020 neighbor 172.16.2.2 address-family ipv4-unicast route-map import 'MAP-IN-HUB'


      set protocols bgp 65020 neighbor 172.16.2.2 ebgp-multihop 4
