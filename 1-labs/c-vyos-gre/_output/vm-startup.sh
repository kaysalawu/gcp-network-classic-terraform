...
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null europe-west2-run.googleapis.com/generate_204) - europe-west2-run.googleapis.com/generate_204"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null us-west2-run.googleapis.com/generate_204) - us-west2-run.googleapis.com/generate_204"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://c-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app/) - https://c-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app/"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://c-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app/) - https://c-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app/"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://c-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app/) - https://c-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app/"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null chuball.p.googleapis.com/generate_204) - chuball.p.googleapis.com/generate_204"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null cspoke1sec.p.googleapis.com/generate_204) - cspoke1sec.p.googleapis.com/generate_204"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null cspoke2sec.p.googleapis.com/generate_204) - cspoke2sec.p.googleapis.com/generate_204"
echo ""
EOF
...
echo ""
echo -e "hub : $(gsutil cat gs://c-hub-eu-storage-bucket)\n"
echo -e "spoke1 : $(gsutil cat gs://c-spoke1-eu-storage-bucket)\n"
echo -e "spoke2 : $(gsutil cat gs://c-spoke2-us-storage-bucket)\n"
EOF
...
while [ $i -lt 3 ]; do
    ...
    ab -n $1 -c $2 europe-west2-run.googleapis.com/generate_204 > /dev/null 2>&1
    ab -n $1 -c $2 us-west2-run.googleapis.com/generate_204 > /dev/null 2>&1
    ab -n $1 -c $2 https://c-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app/ > /dev/null 2>&1
    ab -n $1 -c $2 https://c-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app/ > /dev/null 2>&1
    ab -n $1 -c $2 https://c-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app/ > /dev/null 2>&1
    ab -n $1 -c $2 chuball.p.googleapis.com/generate_204 > /dev/null 2>&1
    ab -n $1 -c $2 cspoke1sec.p.googleapis.com/generate_204 > /dev/null 2>&1
    ab -n $1 -c $2 cspoke2sec.p.googleapis.com/generate_204 > /dev/null 2>&1
    let i=i+1
  sleep 3
done
EOF
