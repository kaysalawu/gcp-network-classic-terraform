...
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null nva.eu.hub.gcp:8001/) - nva.eu.hub.gcp:8001/"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null nva.eu.hub.gcp:8002/) - nva.eu.hub.gcp:8002/"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null nva.us.hub.gcp:8001/) - nva.us.hub.gcp:8001/"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null nva.us.hub.gcp:8002/) - nva.us.hub.gcp:8002/"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null app1.eu.mgt.hub.gcp:8080/) - app1.eu.mgt.hub.gcp:8080/"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null app1.us.mgt.hub.gcp:8080/) - app1.us.mgt.hub.gcp:8080/"
echo -e "\n psc4 ...\n"
...
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null europe-west2-run.googleapis.com/generate_204) - europe-west2-run.googleapis.com/generate_204"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null us-west2-run.googleapis.com/generate_204) - us-west2-run.googleapis.com/generate_204"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://d-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app/) - https://d-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app/"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://d-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app/) - https://d-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app/"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://d-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app/) - https://d-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app/"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null dhuball.p.googleapis.com/generate_204) - dhuball.p.googleapis.com/generate_204"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null dspoke1sec.p.googleapis.com/generate_204) - dspoke1sec.p.googleapis.com/generate_204"
echo  "$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null dspoke2sec.p.googleapis.com/generate_204) - dspoke2sec.p.googleapis.com/generate_204"
echo ""
EOF
...
echo nva.eu.hub.gcp - $(ping -qc2 -W1 nva.eu.hub.gcp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')
echo nva.us.hub.gcp - $(ping -qc2 -W1 nva.us.hub.gcp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')
echo app1.eu.mgt.hub.gcp - $(ping -qc2 -W1 app1.eu.mgt.hub.gcp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')
echo app1.us.mgt.hub.gcp - $(ping -qc2 -W1 app1.us.mgt.hub.gcp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')
EOF
...
echo ""
echo -e "hub : $(gsutil cat gs://d-hub-eu-storage-bucket)\n"
echo -e "spoke1 : $(gsutil cat gs://d-spoke1-eu-storage-bucket)\n"
echo -e "spoke2 : $(gsutil cat gs://d-spoke2-us-storage-bucket)\n"
EOF
...
while [ $i -lt 3 ]; do
    ...
    ab -n $1 -c $2 nva.eu.hub.gcp:8001/ > /dev/null 2>&1
    ab -n $1 -c $2 nva.eu.hub.gcp:8002/ > /dev/null 2>&1
    ab -n $1 -c $2 nva.us.hub.gcp:8001/ > /dev/null 2>&1
    ab -n $1 -c $2 nva.us.hub.gcp:8002/ > /dev/null 2>&1
    ab -n $1 -c $2 app1.eu.mgt.hub.gcp:8080/ > /dev/null 2>&1
    ab -n $1 -c $2 app1.us.mgt.hub.gcp:8080/ > /dev/null 2>&1
    ...
    ab -n $1 -c $2 europe-west2-run.googleapis.com/generate_204 > /dev/null 2>&1
    ab -n $1 -c $2 us-west2-run.googleapis.com/generate_204 > /dev/null 2>&1
    ab -n $1 -c $2 https://d-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app/ > /dev/null 2>&1
    ab -n $1 -c $2 https://d-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app/ > /dev/null 2>&1
    ab -n $1 -c $2 https://d-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app/ > /dev/null 2>&1
    ab -n $1 -c $2 dhuball.p.googleapis.com/generate_204 > /dev/null 2>&1
    ab -n $1 -c $2 dspoke1sec.p.googleapis.com/generate_204 > /dev/null 2>&1
    ab -n $1 -c $2 dspoke2sec.p.googleapis.com/generate_204 > /dev/null 2>&1
    let i=i+1
  sleep 3
done
EOF
