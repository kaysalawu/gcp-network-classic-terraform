...
iptables -A PREROUTING -t nat -p tcp --dport 8001 -j DNAT --to-destination 10.22.21.30:8080
iptables -A PREROUTING -t nat -p tcp --dport 8002 -j DNAT --to-destination 10.22.21.30:8080
iptables -A POSTROUTING -t nat -p tcp --dport 8001 -j SNAT --to-source 10.3.21.10
iptables -A POSTROUTING -t nat -p tcp --dport 8002 -j SNAT --to-source 10.3.21.10
iptables -A POSTROUTING -t nat -d 10.1.21.40 -j SNAT --to-source 10.1.21.50
...
ip rule add to 10.22.0.0/16 table rt5
...
ip route add 10.22.0.0/16 via $ENS5_DGW dev ens5 table rt5
...
ip rule add to 10.2.11.0/24 table rt6
...
ip route add 10.2.11.0/24 via $ENS6_DGW dev ens6 table rt6
...
echo  "\$(curl -kL -H 'Cache-Control: no-cache' --connect-timeout 1 -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null europe-west2-run.googleapis.com/generate_204) - europe-west2-run.googleapis.com/generate_204"
echo  "\$(curl -kL -H 'Cache-Control: no-cache' --connect-timeout 1 -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null us-west2-run.googleapis.com/generate_204) - us-west2-run.googleapis.com/generate_204"
echo  "\$(curl -kL -H 'Cache-Control: no-cache' --connect-timeout 1 -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://e-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app/) - https://e-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app/"
echo  "\$(curl -kL -H 'Cache-Control: no-cache' --connect-timeout 1 -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://e-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app/) - https://e-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app/"
echo  "\$(curl -kL -H 'Cache-Control: no-cache' --connect-timeout 1 -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://e-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app/) - https://e-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app/"
echo  "\$(curl -kL -H 'Cache-Control: no-cache' --connect-timeout 1 -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null ehuball.p.googleapis.com/generate_204) - ehuball.p.googleapis.com/generate_204"
echo  "\$(curl -kL -H 'Cache-Control: no-cache' --connect-timeout 1 -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null espoke1sec.p.googleapis.com/generate_204) - espoke1sec.p.googleapis.com/generate_204"
echo  "\$(curl -kL -H 'Cache-Control: no-cache' --connect-timeout 1 -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null espoke2sec.p.googleapis.com/generate_204) - espoke2sec.p.googleapis.com/generate_204"
echo ""
EOF
