...
2. Navigate to the lab directory
   ...
   ```sh
   cd gcp-network-terraform/1-blueprints-f-simple-hybrid
   ```
...
200 (0.009522s) - 10.10.1.9 - app1.site1.onprem:8080/
200 (0.303636s) - 10.20.1.9 - app1.site2.onprem:8080/
...
app1.site1.onprem - OK 0.026 ms
app1.site2.onprem - OK 139.202 ms
ilb4.eu.hub.gcp - NA
ilb4.us.hub.gcp - NA
ilb7.eu.hub.gcp - NA
ilb7.us.hub.gcp - NA
